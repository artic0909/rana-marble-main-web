        ...
        <table class="email-container" role="presentation" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td class="body-section">
                    @if ($isAdmin)
                        <p class="greeting">New registration Alert!</p>
                        <p class="body-text">
                            Hello Admin, a new customer has just registered on the platform.
                        </p>
                        <div class="quote-card">
                            <p class="author-name-el">Name: {{ $customer->name }}</p>
                            <p class="author-name-el">Email: {{ $customer->email }}</p>
                            <p class="author-name-el">Phone: {{ $customer->phone ?? 'N/A' }}</p>
                        </div>
                    @else
                        <p class="greeting">Dear {{ $customer->name }},</p>
                        <p class="body-text">
                            We warmly welcome you to <strong>Rana Marble</strong> — a home for those who seek the finest
                            in
                            natural stone, sacred craftsmanship, and timeless beauty. Your account has been created and
                            you
                            are now part of a family that takes immense pride in every piece we deliver.
                        </p>
                    @endif
                    <p class="body-text">
                        From exquisitely carved mandirs to premium flooring and decorative stone, each of our creations
                        carries the soul of artisans who have honed their craft across generations in Rajasthan.
                    </p>
                </td>
            </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td width="33%" style="text-align:center; padding:0 10px; vertical-align:top;">
                                ...
                                <p class="feature-desc">Sourced from the finest quarries, verified for grade &amp;
                                    finish</p>
                            </td>
                            <td width="33%" style="text-align:center; padding:0 10px; vertical-align:top;">
                                <div class="feature-icon-wrap">◈</div>
                            ...
                            <td width="33%" style="text-align:center; padding:0 10px; vertical-align:top;">
                                ...
                                <p class="feature-desc">Carefully packed &amp; delivered to your doorstep across India
                                </p>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td class="cta-section">
                    ...
                    <a href="https://ranamarble.info/products" class="cta-button">Explore Collections</a>
                </td>
            </tr>
            ...
            <tr>
                <td class="footer">
                    ...
                    <p class="footer-brand">Marble Singhasan</p>
                    <div style="margin:0 0 16px;">
                        <a href="https://ranamarble.info/products" class="footer-link">Collections</a>
                        <a href="https://ranamarble.info/about" class="footer-link">About Us</a>
                        <a href="https://ranamarble.info/contact" class="footer-link">Contact</a>
                    </div>
                    <p class="footer-address">
                        Rana Marble &amp; Home Marble Singhasan<br>
                        Bagnan, Howrah, West Bengal<br>
                        +917364957139 &nbsp;·&nbsp; ruidas82ramesh@gmail.com
                    </p>
                    <p class="footer-unsub">
                        You received this because you created an account with us.<br>
                        <a href="{{ $unsubscribeUrl ?? 'https://ranamarble.info/' }}">Unsubscribe</a> &nbsp;·&nbsp;
                        <a href="{{ $privacyUrl ?? 'https://ranamarble.info/' }}">Privacy Policy</a>
                    </p>
                </td>
            </tr>
