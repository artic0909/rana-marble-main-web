...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (testiCarousel) {
        ...
        setInterval(() => {
            ...
            let maxScrollLeft =
                testiCarousel.scrollWidth - testiCarousel.clientWidth;
            let scrollAmount =
                testiCarousel.scrollLeft + testiCarousel.clientWidth;
            if (testiCarousel.scrollLeft >= maxScrollLeft - 10)
                scrollAmount = 0;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (relatedCarousel) {
        ...
        setInterval(() => {
            ...
            let maxScrollLeft =
                relatedCarousel.scrollWidth - relatedCarousel.clientWidth;
            let scrollAmount =
                relatedCarousel.scrollLeft + relatedCarousel.clientWidth;
            if (relatedCarousel.scrollLeft >= maxScrollLeft - 10)
                scrollAmount = 0;
            relatedCarousel.scrollTo({
                left: scrollAmount,
                behavior: "smooth",
            });
        }, 3000);
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (bannerCarousel) {
        ...
        setInterval(() => {
            ...
            let maxScrollLeft =
                bannerCarousel.scrollWidth - bannerCarousel.clientWidth;
            let scrollAmount =
                bannerCarousel.scrollLeft + bannerCarousel.clientWidth;
            if (bannerCarousel.scrollLeft >= maxScrollLeft - 10)
                scrollAmount = 0;
